            ...
            <table align="center">
                    ...
                    <td>
                        ...
                        <select name="managerUserId">
                            @foreach($managers as $manager)
                                @if($manager['userId'] == $event['managerId'])
                                    @if($manager['status'] != 1)
                                        <strong>No Manager</strong>
                                        @break
                                    @endif
                                    <option selected="true" value="{{$manager['userId']}}" name="{{$manager['userId']}}">{{$manager['userName']}}</option>
                                @else
                ...
                <tr>
                    <td>
                        ...
                        @else
                            <strong>
                                Manager deactivated. <a href="/event/chooseManagerForUpdate/{{$event['eventId']}}">Choose to Update</a>
                            </strong>
                        @endif
                    </td>
                    <td></td>
                ...
                <tr>
                    <td>
                        <label style="color: #ab237e">Starting date: </label><strong>{{$event['startDate']}}</strong>
                    </td>
                    <td></td>
                </tr>
                {{--<tr>
                ...
                <tr>
                    <td>
                        <label style="color: #ab237e">Closing date: </label><strong>{{$event['endDate']}}</strong>
                    </td>
                    <td></td>
                </tr>
                {{--<tr>
